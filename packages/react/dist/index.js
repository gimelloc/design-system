...
var Button = (0, import_react3.styled)("button", {
  all: "unset",
  borderRadius: "$sm",
  fontSize: "$sm",
  fontWeight: "$medium",
...
var TooltipContent = (0, import_react4.styled)(TooltipPrimitive.Content, {
  padding: "$3 $4",
  background: "$gray900",
  color: "$gray100",
  fontFamily: "$default",
...
var TooltipArrow = (0, import_react4.styled)(TooltipPrimitive.Arrow, {
  fill: "$gray900"
});
...
function Tooltip({ content, children, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipPrimitive2.Provider, {
    children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipPrimitive2.Root, {
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipPrimitive2.Trigger, {
          asChild: true,
          children
        }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipPrimitive2.Portal, {
...
var hide = (0, import_react5.keyframes)({
  "0%": { opacity: 1 },
  "100%": { opacity: 0 }
});
var slideIn2 = (0, import_react5.keyframes)({
  from: { transform: `translateX(calc(100% + ${VIEWPORT_PADDING}px))` },
  to: { transform: "translateX(0)" }
});
var swipeOut = (0, import_react5.keyframes)({
  from: { transform: "translateX(var(--radix-toast-swipe-end-x))" },
  to: { transform: `translateX(calc(100% + ${VIEWPORT_PADDING}px))` }
});
var ToastRoot = (0, import_react5.styled)(ToastPrimitive.Root, {
  padding: "$3 $4",
  background: "$gray800",
  border: "1px solid $gray600",
  borderRadius: "$sm",
...
var ToastTitle = (0, import_react5.styled)(ToastPrimitive.Title, {
  color: "$white",
  fontWeight: "$bold",
  fontSize: "$xl",
  lineHeight: "$base"
});
var ToastDescription = (0, import_react5.styled)(ToastPrimitive.Description, {
  color: "$gray200",
  fontSize: "$sm",
  lineHeight: "$base",
  marginTop: "$1"
});
var ToastClose = (0, import_react5.styled)(ToastPrimitive.Close, {
  position: "absolute",
  top: "$4",
  right: "$4",
  background: "none",
...
var ToastViewport2 = (0, import_react5.styled)(ToastPrimitive.ToastViewport, {
  position: "fixed",
  bottom: 0,
  right: 0,
  display: "flex",
...
function Toast({ title, description, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(ToastPrimitive2.Provider, {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToastViewport2, {})
    ]
  });
}
